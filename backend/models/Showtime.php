...
class Showtime extends Model {
    ...
    public function __construct(array $data) {
        ...
        $this->ticket_price  = isset($data["ticket_price"]) ? (float)$data["ticket_price"] : 10.00;
    }
    ...
    public function toArray(): array {
        return [$this->id,$this->movie_id,$this->show_datetime,$this->capacity,
                $this->created_at,$this->ticket_price];
    }
